...
RSCRIPT_DIU = "/gpfs/mrc0/projects/Research_Project-MRC148213/sl693/scripts/LOGen/differential_analysis/run_DIU_commandLine.R"
...
def generate_gene_specific_files(args, gene):
    ...
    with open(args.classFile, 'r') as file:
        ...
        for line in file.readlines()[1:]:  # Skip the first line
            associated_gene = line.split("\t")[first_line.split("\t").index("associated_gene") + 1]
            isoform = line.split("\t")[1]
