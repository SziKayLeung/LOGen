...
# modified by S.K.Leung: remove input of kallisto tmp file and ribodepletion file 
# therefore remove output of gene_level info table
...
def main():
    ...
    parser.add_argument('--tpm', '-t', action='store', dest='tpm_file',help='Kallisto TPM file location', default=None)
